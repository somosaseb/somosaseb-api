    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('icon', models.ImageField(blank=True, upload_to=aseb.core.db.utils.UploadToFunction('websites/{obj.pk}/{filename}.{ext}'))),
                ('status', models.CharField(choices=[('publish', 'Published'), ('publishing', 'Publishing')], default='publish', max_length=10)),
                ...
                ('reader_access', models.CharField(choices=[('public', 'Public'), ('private', 'Private, require authentication')], default='public', max_length=10)),
                ('custom_robots_txt', models.TextField(blank=True)),
                ('created_by', models.ForeignKey(blank=True, editable=False, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='+', to=settings.AUTH_USER_MODEL)),
                ('modified_by', models.ForeignKey(blank=True, editable=False, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='+', to=settings.AUTH_USER_MODEL)),
                ('removed_by', models.ForeignKey(blank=True, editable=False, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='+', to=settings.AUTH_USER_MODEL)),
                ('root_page', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='+', to='pages.page')),
            ],
            options={
                'abstract': False,
